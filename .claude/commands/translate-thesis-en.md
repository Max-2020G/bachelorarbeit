...
Bring the English translation back in sync after the German source has
changed, and rebuild the English PDF:
...
existing translation), just do the translation directly instead of following
this diff-based workflow.
