...
Zum beispiel ist das Licht zwischen einer Wellenlänge von \SIrange{380}{750}{\nano\meter} im sichtbaren bereich. 
...
\begin{figure}[H]
    ...
    Oben die Haupt erzeugungsarten für Strahlung in dem Jeweiligen Frequenzbereich.}
    \label{fig:Spek}
\end{figure}
...
\begin{figure}[H]
    ...
    Die beiden Leistungen sinken in richtung der eingzeichneten THz-Lücke in der mitte, Grafik aus \cite{thz_gap}.}
    \label{fig:THz-lucke}
\end{figure}
...
Sie ist der Hauptmechanismus, mit dem die organischen Emitter THz-Strahlung erzeugen, 
welche in dieser Arbeit auf ihre Fähigkeit zur THz-Erzeugung geprüft werden. \\ \\
...
Die organischen Kristalle werden in der Arbeitsgruppe Steffen an der TU Dortmund gezüchtet/hergestellt, 
