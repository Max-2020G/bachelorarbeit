...
\begin{equation}
    \label{eqn:NLP}
    P_{i,j} = \epsilon_0 \left(\chi^{(1)}_{i_1,j_1}E+\chi^{(2)}_{i_2,j_2}E^2+\chi^{(3)}_{i_3,j_3}E^3+\dotsb\right)
\end{equation}
...
welche in nur 21 der 32 Kristallgruppen vorliegt und somit nicht für die Generation von THz infrage kommen. 
...
\end{equation}
Damit die beiden Felder, die auf den Generationskristall treffen, keine destruktive Interferenz 
...
$n_0$ der Brechungsindex des Detektionskristalls bei der Wellenlänge $\lambda_0$, $d_\text{THz}$ ist nichtlineare Koeffizient des 
...
Dazu ist der nicht lineare Koeffizient bei $\SI{800}{nm}$-Strahlung $d_{THz}= \SI{66.6}{pm/V}$ \cite{wu2014comparison}.
